...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public Account(string name, string email, string password, IPasswordHasherService passwordHasherService)
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            ArgumentNullException.ThrowIfNull(passwordHasherService);
            Name = name;
            EmailAddress = email;
            HashedPassword = passwordHasherService.HashPassword(this, password);
        }

#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        [JsonConstructor]
        private Account(Guid id, string name, string emailAddress, string password, IPasswordHasherService passwordHasherService)
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            ArgumentNullException.ThrowIfNull(passwordHasherService);
            _id = id;
